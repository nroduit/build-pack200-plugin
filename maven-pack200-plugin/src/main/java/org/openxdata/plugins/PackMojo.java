            ...
            try {
                ...
                if (normalizeOnly) {
                    ...
                    Artifact newArtifact =
                        new DefaultArtifact(artifactToPack.getGroupId(), artifactToPack.getArtifactId(),
                            artifactToPack.getVersionRange(), artifactToPack.getScope(), type,
                            artifactToPack.getClassifier(), new DefaultArtifactHandler(type));
